...
/datum/body_accessory
	...
	var/own_delay = null //The name of the icon state in body_accessory.dmi should be the accessory's icon_state as defined in the datum suffixed with _delay. [icon_state]_delay

...
/datum/species/unathi
	...
	flags = HAS_LIPS
	clothing_flags = HAS_UNDERWEAR | HAS_UNDERSHIRT | HAS_SOCKS
	bodyflags = FEET_CLAWS | HAS_TAIL | TAIL_WAGGING | HAS_HEAD_ACCESSORY | HAS_MARKINGS | HAS_SKIN_COLOR | HAS_ALT_HEADS
	dietflags = DIET_CARN
...
/datum/species/vulpkanin
	...
	flags = HAS_LIPS
	clothing_flags = HAS_UNDERWEAR | HAS_UNDERSHIRT | HAS_SOCKS
	bodyflags = FEET_PADDED | HAS_TAIL | TAIL_WAGGING | HAS_HEAD_ACCESSORY | HAS_MARKINGS | HAS_SKIN_COLOR | HAS_FUR
	dietflags = DIET_OMNI
	reagent_tag = PROCESS_ORG
	flesh_color = "#966464"
	base_color = "#CF4D2F"
...
/datum/species/vox
	...
	dietflags = DIET_OMNI
	bodyflags = HAS_ICON_SKIN_TONE | HAS_TAIL | TAIL_WAGGING | HAS_BODY_MARKINGS | HAS_TAIL_MARKINGS

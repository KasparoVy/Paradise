...
/datum/species/unathi
	...
	flags = HAS_LIPS
	clothing_flags = HAS_UNDERWEAR | HAS_UNDERSHIRT | HAS_SOCKS
	bodyflags = FEET_CLAWS | HAS_TAIL | TAIL_WAGGING | TAIL_OVERLAPPED | HAS_HEAD_ACCESSORY | HAS_MARKINGS | HAS_SKIN_COLOR | HAS_ALT_HEADS
	dietflags = DIET_CARN
...
/datum/species/tajaran
	...
	flags = HAS_LIPS | CAN_BE_FAT
	clothing_flags = HAS_UNDERWEAR | HAS_UNDERSHIRT | HAS_SOCKS
	bodyflags = FEET_PADDED | HAS_TAIL | HAS_HEAD_ACCESSORY | HAS_HEAD_MARKINGS | HAS_BODY_MARKINGS | HAS_SKIN_COLOR | TAIL_WAGGING | TAIL_OVERLAPPED | HAS_FUR
	dietflags = DIET_OMNI
	reagent_tag = PROCESS_ORG
	flesh_color = "#AFA59E"
	base_color = "#424242"

...
#define APPEARANCE_ALT_PARTS 16384
#define APPEARANCE_ALL_BODY APPEARANCE_ALL_HAIR|APPEARANCE_HEAD_ACCESSORY|APPEARANCE_BODY_ACCESSORY|APPEARANCE_MARKINGS|APPEARANCE_ALT_PARTS
